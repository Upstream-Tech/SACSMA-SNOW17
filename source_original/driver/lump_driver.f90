...
! print *,'here 4'
    ! write(*,*) 'cs:', cs
    ! write(*,*) 'tprev: ', tprev
    ! write(*,*) 'output: ', raim(i),sneqv(i),snow(i),snowh(i)
    ! write(*,*) '------------'

!print *,'snow',snow(i),snowh(i)
    ! write(*,*) year(i), month(i), day(i), real(dt)
    ! write(*,*) precip_sp, tair_sp, pet_sp
    ! write(*,*) uztwc_sp, uzfwc_sp, lztwc_sp, lzfsc_sp, lzfpc_sp, adimc_sp
