...
C     RCS Id string, for version control
      ...
      REAL DT,PXV,EP,TCI,ROIMP,SDRO,SSUR,SIF,BFS,BFP,TET
      REAL IFRZE,TA,LWE,WE,ISC,AESC
      REAL UZTWM,UZFWM,UZK,PCTIM,ADIMP,RIVA,ZPERC
      REAL REXP,LZTWM,LZFSM,LZFPM,LZSK,LZPK,PFREE
      REAL SIDE,RSERV

      REAL :: FR=1.0  ! FR IS THE CHANGE IN PERCOLATION WITHDRAWAL DUE TO FROZEN GROUND.
      REAL :: FI=1.0  ! FI IS THE CHANGE IN INTERFLOW WITHDRAWAL DUE TO FROZEN GROUND.
...
C     U/COMMONR ZONE FREE WATER RATIO EXCEEDS UPPER ZONE
...
C.......................................
      REAL LZTWM,LZFSM,LZFPM,LZSK,LZPK,LZTWC,LZFSC,LZFPC
      REAL PX, SUR, DIR, TA, LWE, WE, ISC, AESC, DT
C
C     COMMON BLOCKS
      COMMON/SACPARM1/UZTWM,UZFWM,UZK,PCTIM,ADIMP,RIVA,ZPERC,REXP,LZTWM,
     &                LZFSM,LZFPM,LZSK,LZPK,PFREE,SIDE,RSERV
      COMMON/SACSTAT1/UZTWC,UZFWC,LZTWC,LZFSC,LZFPC,ADIMC
      COMMON/FSMCO1/FGCO(6),RSUM(7)
      COMMON/FPMFG1/FGPM(10)
C.......................................
