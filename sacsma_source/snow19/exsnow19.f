...
C     FORCINGS
      REAL, INTENT(IN) :: IDTS,IDT,IDA,IMN,IYR,
      REAL, INTENT(IN) :: PCP,TMP

C     STATES
      REAL, INTENT(INOUT) :: CS, TPREV

C     PARAMETERS
      REAL, INTENT(IN) :: ALAT, SCF, MFMAX1, MFMIN1, UADJ1, SI, NMF1, TIPM1
      REAL, INTENT(IN) :: MBASE, PXTEMP, PLWHC, DAYGM, ELEV1, PA, ADC

C     OUTPUT
      REAL, INTENT(OUT) :: RAIM,S NEQV, SNOW, SNOWH
